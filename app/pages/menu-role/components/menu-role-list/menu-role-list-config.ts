...
const tableColumns: TableColumns<MenuRoleResponse>[] = [
  {
    label: "MENUS",
...
export const componentSettings = {
  ...
  filename: "listado-de-menu-roles",
};
