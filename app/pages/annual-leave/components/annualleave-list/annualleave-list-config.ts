...
const searchOptions: SearchOptions[] = [
  {
    ...
    validation_desc: "Sólo se permite números en esta búsqueda.",
    icon: "icName",
  },
  {
    label: "Dias",
    value: 2,
    placeholder: "Buscar por dias",
    validation: [GenericValidators.numeric],
    validation_desc: "Sólo se permite números en esta búsqueda.",
    icon: "icName",
  },
...
const tableColumns: TableColumns<AnnualLeaveResponse>[] = [
  {
    label: "NOMBRE",
  ...
  },
  {
    label: "ESTADO",
    cssLabel: ["font-bold", "text-sm"],
    property: "stateAnnualLeaveBalance",
    cssProperty: ["font-semibold", "text-sm", "text-left"],
    type: "badge",
    sticky: false,
    sort: false,
...
export const componentSettings = {
  ...
  filename: "listado-de-días-anuales",
};
